...
```{r startup screen, out.width = 1920, echo=F, fig.cap='Figure 1: This is what RStudio looks like when you start it up.'}
knitr::include_graphics("startup_screen_1.png")
```
